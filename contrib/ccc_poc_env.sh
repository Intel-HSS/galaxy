...
export ELPREP_PATH=$GENOMICS_DIR/ohsu/dnapipeline/elprep-v2.34/  
export PATH=$ELPREP_PATH:$STAR_PATH:$BAMUTIL_PATH:$SAMBAMBA_PATH:$PINDEL_PATH:$BREAKDANCER_PATH:$TOPHAT_EXE_PATH:$CUFFLINKS_TOOLS_EXE_PATH:$BOWTIE_TOOLS_EXE_PATH:$GENOMICS_DIR:$BWA_DIR:$SAMTOOLS_DIR:$SAMTOOLS_v020_EXE_PATH:$PICARD_PATH:$PYTHON_2_7_PATH/bin:$SPARK_HOME/bin:$ADAM_HOME/bin:$PATH
export NSLOTS=16
